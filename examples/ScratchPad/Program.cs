...
namespace ScratchPad
{
    class Program
    {
        ...
        private static void PerfTest1() 
        {
            ...
            var x = xt.random.Uniform(new XtlSharp.Shape(300, 100), 0, 1, XtlSharp.DType.Float32);
            var y = xt.random.Uniform(new XtlSharp.Shape(300, 100), 0, 1, XtlSharp.DType.Float32);
